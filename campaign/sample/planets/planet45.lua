			...
			aiConfig = {
				{
					...
					difficultyDependantUnlocks = {
						[2] = {"amphassault"},
						[3] = {"amphassault", "gunshipassault", "spiderantiheavy", "jumpbomb"},
						[4] = {"amphassault", "gunshipassault", "spiderantiheavy", "jumpbomb", "gunshipheavyskirm"}, --maybe someday circuit will learn to crabenap? lol
					},
					commanderLevel = 5,
					commander = {
						name = "Yarral",
