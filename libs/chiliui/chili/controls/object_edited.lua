...
function Object:KeyPress(...)
	Spring.Echo("Chilli Object:Keypress")
	if (self:CallListeners(self.OnKeyPress, ...)) then
		Spring.Echo("Chilli Object:Keypress return self")
		return self
	end
	Spring.Echo("Chilli Object:Keypress return false")
	return false
end


function Object:TextInput(...)
	Spring.Echo("Chilli Object:TextInput")
