...
--// Info
if (info) then
  local ratios      = {["1to1"]=(1/1)} --["5to4"]=(4/5)} --{["16to10"]=(10/16), , ["5to4"]=(4/5)} --, ["4to3"]=(3/4)}
...
factionColors = {
  unknown = {0.05, 0.96, 0.05},   --// unknown
}
...
bgColor = {0.7, 0.7, 0.7, 0.85} -- for colourising backgrounds

--// Ambient Occlusion & Outline settings
aoPower     = ((scheme=="bw") and 1.5) or 2
aoContrast  = ((scheme=="bw") and 2.5) or 4
aoTolerance = 0
olContrast  = ((scheme=="bw") and 5) or 10
olTolerance = 0

--// halo (white)
halo  = true --false --(scheme~="bw")
...
--//ground
  ...
  {check={},                                                 texture="Unitpics/GBRBackground.png"}, --"LuaRules/Images/IconGenBkgs/bg_ground.png"},
}
