return {
	...
	en = {
		...
		-- campaign handler
		campaign = "Campaign",
		campaign_caps = "CAMPAIGN",
		intermission_caps = "INTERMISSION",
		new_game = "New Game",
		...
		save_overwrite_confirm = "Overwrite this save?",
		load = "Load",
		load_caps = "LOAD",
		load_confirm = "Loading will lose any unsaved progress. Continue?",
		delete = "Delete",
