...
local function CheckTutorialPopup()
	...
	TextBox:New {
		...
		text = [[From here you can embark on a galaxy-spanning campaign or play a skirmisk against the AI - all under Singleplayer & Coop (invite your friends). Alternately, you can click Multiplayer to a host private game, hop into the matchmaker, or participate in massive public games.]],
		parent = tutorialWindow,
	}
