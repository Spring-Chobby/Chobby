...
local singleplayerConfig = VFS.Include(LUA_DIRNAME .. "configs/gameConfig/zkdev/singleplayerMenu.lua")
local helpSubmenuConfig  = VFS.Include(LUA_DIRNAME .. "configs/gameConfig/" .. shortname .. "/helpSubmenuConfig.lua")
local skirmishDefault    = VFS.Include(LUA_DIRNAME .. "configs/gameConfig/zkdev/skirmishDefault.lua")
...
local externalFuncAndData = {
	dirName                = "zkdev",
	name                   = "Zero-K Dev",
	_defaultGameArchiveName = "Zero-K $VERSION",
