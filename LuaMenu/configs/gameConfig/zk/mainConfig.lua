...
local externalFuncAndData = {
	dirName                 = "zk",
	name                    = "Zero-K",
	_defaultGameArchiveName = "Zero-K v1.7.3.10", -- Do not read directly (except as fallback in case rapid breaks, make sure to keep this version recent enough that it doesn't break on fresh engines)
